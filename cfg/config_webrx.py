...
# ==== Server settings ====
web_port=8073
server_hostname="websdr.jiangwei.org" # If this contains an incorrect value, the web UI may freeze on load (it can't open websocket)
max_clients=20

# ==== Web GUI configuration ====
receiver_name="[Callsign]"
receiver_location="ShangHai, China"
receiver_qra="JN97ML"
receiver_asl=200
receiver_ant="Longwire"
receiver_device="S9-C"
receiver_admin="jiangwei@jiangwei.org"
